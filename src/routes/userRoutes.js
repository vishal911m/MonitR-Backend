...
import { forgotPassword, getUser, loginUser, logoutUser, registerUser, updateUser, userLoginStatus, verifyEmail, verifyUser } from '../controller/auth/userController.js';
